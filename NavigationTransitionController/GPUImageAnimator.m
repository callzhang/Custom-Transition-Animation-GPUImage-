...
@property (nonatomic, strong) GPUImageiOSBlurFilter* sourcePixellateFilter;
...
- (void)setup
{
    ...
    self.sourcePixellateFilter = [[GPUImageiOSBlurFilter alloc] init];
    self.sourcePixellateFilter.blurRadiusInPixels = 0;
...
- (void)frame:(CADisplayLink*)link
{
    ...
    self.sourcePixellateFilter.blurRadiusInPixels = self.progress * 20;
    //rself.targetPixellateFilter.blurRadiusInPixels = (1- self.progress) * 20;
    [self triggerRenderOfNextFrame];
